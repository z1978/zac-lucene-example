...
//        String dataDir = "D:\\lucene\\data"; //需要索引的文件数据存放的目录
        String indexDir = "/Users/zhangningbo/develop/lucene"; //将索引保存到的路径
        String dataDir = "/Users/zhangningbo/develop/lucene/data"; //需要索引的文件数据存放的目录
